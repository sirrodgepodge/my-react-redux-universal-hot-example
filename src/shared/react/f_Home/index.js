...
// components
import CounterButton from 'shared/common/components/r_CounterButton';
import GithubButton from 'shared/common/components/f_GithubButton';


export default function Home() {
  const styles = require('./style.scss');
  // require the logo image both from client and server
  const logoImage = require('shared/common/assets/logo.png');
  return (
