...
import * as widgetsActions from 'shared/redux/reducers/widgets'; // eslint-disable-line import/no-duplicates
import {isLoaded, load as loadWidgets} from 'shared/redux/reducers/widgets'; // eslint-disable-line import/no-duplicates
...
@connect(
  ...
  {...widgetsActions, initializeWithKey })
